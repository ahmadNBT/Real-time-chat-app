...
const ProfilePage = () => {
    ...
    const {user, setUser, loading ,isAuth} = useAppData()
                                ...
                                isEdit ? (
                                    <form onSubmit={submitHandler} className='space-y-4'>
                                        ...
                                        <div className='flex gap-3'>
                                            ...
                                            <button className='flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg' onClick={editHandler} type='button'> 
                                                Cancel
                                            </button>
                                        </div>
                                    </form>
                                    ...
                                    <div className='flex items-center justify-between p-4 bg-gray-700 rounded-lg border border-gray-600'>
                                        ...
                                        <button className='flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg' onClick={editHandler}>Edit</button>
                                    </div>
                                )
                            }
                        </div>
