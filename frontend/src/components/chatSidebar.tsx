  ...
  return (
    ...
    >
      ...
      <div className="border p-6 border-gray-700">
        <div className="flex justify-end mb-0 sm:hidden">
          <button
        ...
        {showAllUsers ? (
          <div className="space-y-4 h-full">
            <div className="relative">
              ...
              <input
                ...
                className="w-full py-3 pl-10 pr-4 border border-gray-700 bg-gray-800 rounded-md text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
              />
            </div>
                ...
                users
                  ...
                  .map((user) => (
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-lg border border-gray-700 hover:border-gray-600 hover:bg-gray-700 transition-colors`}
                    >
                      <div className="flex items-center gap-3 ">
                        <div className="relative">
                          ...
                          {/* online symbol */}
                          {
                            onlineUsers.includes(user._id) && (
                              <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-gray-900"></span>
                            )
                          }
                        </div>
          ...
          <div className="space-y-2 overflow-y-auto h-full pb-4">
            {chats.map((chat) => {
              ...
              const isSentByMe =
                latestMessage?.sender.toString() === loggedInUser?._id;
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-400 font-medium">No chats available</p>
            <p className="text-sm text-gray-500 mt-1">Start a New chat to begin messages </p>
          </div>
        )}
      </div>
...
{/* footer */}
            <div className="p-4 border-t border-gray-700 space-y-2">
                ...
                <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-red-600 text-red-500 hover:text-white transition-colors ">
