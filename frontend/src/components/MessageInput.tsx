import { Loader2, Paperclip, Send, UserCircle, X } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          type="text"
          className="flex-1 bg-gray-700 rounded-lg px-4 py-2 text-white placeholder:text-gray-400"
          value={message}
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 rounded-lg px-4 py-2 flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed text-white transition-colors"
        >
            {
                isUploading ? (
